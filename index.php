...
.city input {
    border: none !important;
    border-radius: 30px !important; /* Round corners */
                    ...
                    <div class="col-lg-5">
                        <div class="banner-content">
                            <div class="intro-form" style="background:rgb(237 197 210 / 60%);">
                                <div class="intro-form-inner text-center">
									<h3>Sign Up </h3>
                ...
                <div class="row justify-content-center g-3 g-md-4">
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="lab-item member-item style-1">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="images/pp.avif" alt="member-img">
                                </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="lab-item member-item style-1">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="images/male.webp" alt="member-img">
                                </div>
                                <div class="lab-content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="lab-item member-item style-1">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="images/ff.jpg" alt="member-img">
                                </div>
                                <div class="lab-content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="lab-item member-item style-1">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="images/oo.jpg" alt="member-img">
                                </div>
                                <div class="lab-content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="lab-item member-item style-1">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="images/fa.jpg" alt="member-img">
                                </div>
                                <div class="lab-content">
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                        <div class="lab-item member-item style-1">
                            <div class="lab-inner">
                                <div class="lab-thumb">
                                    <img src="images/s.jpg" alt="member-img">
                                </div>
                                <div class="lab-content">
    ...
    <section class="group-section padding-tb bg-img">
        <div class="container">
            <div class="section-header">
                ...
                <h2>beSocial coupale Best Active Group</h2>
            </div>
            <div class="section-wrapper">
                <div class="row g-4">
                    ...
                    <div class="col-xl-6 col-12">
                        <div class="group-item lab-item">
                            <div class="lab-inner d-flex flex-wrap align-items-center p-4">
                                <div class="lab-thumb me-sm-4 mb-4 mb-sm-0">
                                    <img src="images/OIP.webp" alt="img">
                                </div>
                                <div class="lab-content text-center">
